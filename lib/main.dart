...
class _HomeState extends State<Home> {
  ...
  List<CatalogItem> catalogItems = [
    CatalogItem(nameItem: 'BagPack', priceItem: '12.00', imageItem: 'image_backpack.png', descriptionItem: 'This is a backpack'),
    CatalogItem(nameItem: 'T-Shirt', priceItem: '10.00', imageItem: 'image_t-shirt.png', descriptionItem: 'This is a t-shirt'),
    CatalogItem(nameItem: 'Cap', priceItem: '30.00', imageItem: 'image_cap.png', descriptionItem: 'This is a cap'),
  ];
